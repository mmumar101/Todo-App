...
//##########################################################################################################################
  return (
    <div className={`min-h-screen pb-20 ${theme === 'light' ? 'bg-[#32325d]' : 'bg-[#f2f2f2]'}`}>
      <div className={` bg-[#4343b7] bg-no-repeat bg-cover h-52 px-5 py-2`}>
        <div className='flex justify-between items-center lg:w-[50%] lg:mx-auto mt-5'>
          <p className={`text-3xl font-semibold tracking-[6px] ${theme === 'light' ? 'text-white' : 'text-black'}`}>TODO</p>
      ...
      <div className={` h-60 mx-5 rounded-md w-[5/6] relative -top-8 md:w-[48.5%] md:mx-auto lg:w-[48.5%] lg:mx-auto text-white`}>
